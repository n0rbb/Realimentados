###########################################################################
## Makefile generated for component 'controller_real'. 
## 
## Makefile     : controller_real.mk
## Generated on : Wed Jan 17 10:49:23 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/controller_real.elf
...
PRODUCT_NAME              = controller_real
MAKEFILE                  = controller_real.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/miqui/OneDrive/UNIVER~1/423-24~1/REALIM~1/PRACTI~1/REALIZ~1/MOTOR_~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = controller_real_comp.rsp
CMD_FILE                  = controller_real.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/controller_real.elf
...
DEFINES_STANDARD = -DMODEL=controller_real -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o MW_PWM.o xcp_ext_mode.o controller_real.o controller_real_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
LDFLAGS_ = @C:\Users\miqui\OneDrive\UNIVER~1\423-24~1\REALIM~1\PRACTI~1\REALIZ~1\MOTOR_~1\CONTRO~1\MBED_O~1.RSP
...
SHAREDLIB_LDFLAGS_ = @C:\Users\miqui\OneDrive\UNIVER~1\423-24~1\REALIM~1\PRACTI~1\REALIZ~1\MOTOR_~1\CONTRO~1\MBED_O~1.RSP
...
CPP_LDFLAGS_ = @C:\Users\miqui\OneDrive\UNIVER~1\423-24~1\REALIM~1\PRACTI~1\REALIZ~1\MOTOR_~1\CONTRO~1\MBED_O~1.RSP
...
CPP_SHAREDLIB_LDFLAGS_ = @C:\Users\miqui\OneDrive\UNIVER~1\423-24~1\REALIM~1\PRACTI~1\REALIZ~1\MOTOR_~1\CONTRO~1\MBED_O~1.RSP
...
%.o : $(START_DIR)/controller_real_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/controller_real_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controller_real_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/controller_real_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controller_real_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
controller_real.o : $(START_DIR)/controller_real_ert_rtw/controller_real.c
	$(CC) $(CFLAGS) -o "$@" "$<"


controller_real_data.o : $(START_DIR)/controller_real_ert_rtw/controller_real_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/controller_real_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
