###########################################################################
## Makefile generated for component 'motor_real'. 
## 
## Makefile     : motor_real.mk
## Generated on : Wed Jan 17 11:21:13 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/motor_real.elf
...
PRODUCT_NAME              = motor_real
MAKEFILE                  = motor_real.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/miqui/OneDrive/UNIVER~1/423-24~1/REALIM~1/PRACTI~1/REALIZ~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = motor_real_comp.rsp
CMD_FILE                  = motor_real.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/motor_real.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DINTERNAL_XCP_MEM_BLOCK_1_SIZE=160 -DINTERNAL_XCP_MEM_BLOCK_1_NUMBER=1 -DINTERNAL_XCP_MEM_BLOCK_2_SIZE=168 -DINTERNAL_XCP_MEM_BLOCK_2_NUMBER=5 -DINTERNAL_XCP_MEM_BLOCK_3_SIZE=32 -DINTERNAL_XCP_MEM_BLOCK_3_NUMBER=5 -DINTERNAL_XCP_MEM_RESERVED_POOLS_TOTAL_SIZE=1738 -DINTERNAL_XCP_MEM_RESERVED_POOLS_NUMBER=6 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=2 -DXCP_MIN_EVENT_NO_RESERVED_POOL=3 -DXCP_MAX_CTO_SIZE=255 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2000 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
...
DEFINES_STANDARD = -DMODEL=motor_real -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o MW_PWM.o xcp_ext_mode.o motor_real.o motor_real_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
LDFLAGS_ = @C:\Users\miqui\OneDrive\UNIVER~1\423-24~1\REALIM~1\PRACTI~1\REALIZ~1\MOTOR_~2\MBED_O~1.RSP
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry=Reset_Handler --specs=nano.specs --specs=nosys.specs -T"C:\ProgramData\MATLAB\SupportPackages\R2023b\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F411RE/TOOLCHAIN_GCC_ARM/STM32F411XE.ld"
...
SHAREDLIB_LDFLAGS_ = @C:\Users\miqui\OneDrive\UNIVER~1\423-24~1\REALIM~1\PRACTI~1\REALIZ~1\MOTOR_~2\MBED_O~1.RSP
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry=Reset_Handler --specs=nano.specs --specs=nosys.specs -T"C:\ProgramData\MATLAB\SupportPackages\R2023b\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F411RE/TOOLCHAIN_GCC_ARM/STM32F411XE.ld"
...
CPP_LDFLAGS_ = @C:\Users\miqui\OneDrive\UNIVER~1\423-24~1\REALIM~1\PRACTI~1\REALIZ~1\MOTOR_~2\MBED_O~1.RSP
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry=Reset_Handler --specs=nano.specs --specs=nosys.specs -T"C:\ProgramData\MATLAB\SupportPackages\R2023b\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F411RE/TOOLCHAIN_GCC_ARM/STM32F411XE.ld"
...
CPP_SHAREDLIB_LDFLAGS_ = @C:\Users\miqui\OneDrive\UNIVER~1\423-24~1\REALIM~1\PRACTI~1\REALIZ~1\MOTOR_~2\MBED_O~1.RSP
...
%.o : $(START_DIR)/motor_real_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/motor_real_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/motor_real_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/motor_real_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/motor_real_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/motor_real_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motor_real.o : $(START_DIR)/motor_real_ert_rtw/motor_real.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motor_real_data.o : $(START_DIR)/motor_real_ert_rtw/motor_real_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
mw_mbed_interface.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/stmnucleo/STM32F411RE/src/mw_mbed_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
