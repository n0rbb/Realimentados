...
\left.\begin{cases}
	...
	\begin{cases}
		x_1(t) &= x_1^* + \delta x_1(t) \\
		x_2(t) &= x_2^* + \delta x_2(t) \\
...
\item Simular el modelo para valores $m=2.5Kg$, $c=0.6Ns/m$ y $k=0.4N/m$, empleando Matlab. Considerar los siguientes casos,
